...
// src/features/onboarding/components/Step4group.tsx
...
interface Step4groupProps {
  onValidate: (isValid: boolean) => void;
}

const Step4group: React.FC<Step4groupProps> = ({ onValidate }) => {
  ...
  const handleValuesChange = (_: any, allValues: { choiceCheckbox: string[] }) => {
